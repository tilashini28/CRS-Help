...
$db = mysqli_connect('localhost', 'root', '', 'crs-help'); 
 ...
 if(isset($_POST['loginManager'])){
	...
	if($username == $myusername and $password == $mypassword){
		...
		header("location: managerIndex1.php");
	}
	session_start();
	...
	echo "Username or Password is Invalid.,br> click here <a href='managerLogin1.php'> try again</a>";
	
	
	header("location: managerLogin1.php");}
