...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <!-- 
    ...
    <form method = "post" action="managerValidation.php">
        ...
        <div class="form-group">
            <button type="submit" class="btn btn-primary btn-lg btn-block" name="loginManager" value="loginManager">Login As Manager</button>
        </div>
		<div class="clearfix">
