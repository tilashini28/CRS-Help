		...
		<header id="fh5co-header-section" class="sticky-banner">
			<div class="container">
				<div class="nav-header">
					...
					<h1 id="fh5co-logo"><a href="index.html">CRS-HELP</a></h1>
					...
					<nav id="fh5co-menu-wrap" role="navigation">
						<ul class="sf-menu" id="fh5co-primary-menu">
							...
							<li> <?php
									...
									echo $_SESSION['managerUsername'];
									echo "<a href='managerLogout.php'> logout</a>";
									?>
		...
		<div class="fh5co-hero">
			...
			<div class="fh5co-cover text-center" data-stellar-background-ratio="0.5" style="background-image: url(images/cover_bg_2.jpg);">
				<div class="desc animate-box">
					<h2>CRS-HELP<strong> Non-profit</strong></h2>
					<br>
					<br>
					<span><a class="btn btn-primary btn-lg" href="registerStaff2.php">ADD STAFF</a></span>
					<span><a class="btn btn-primary btn-lg" href="addVolunteer.php">ADD VOLUNTEER</a></span>
				</div>
			</div
